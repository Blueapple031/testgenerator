...
def vision_filter_for_pipeline(pipeline: ExtractionPipelineMode) -> Callable[[PageText], bool]:
    """파이프라인별 Vision 대상 페이지 판별."""
    if pipeline == "ocr_first":
        return ExtractionService.is_page_sparse
    return ExtractionService.page_needs_vision
